...
const SignInScreen = ({navigation}) => {
    ...
    return (
        <View style={stylesssss.container}>
            <StatusBar backgroundColor='#148beb' barStyle="light-content" />
            <View style={stylesssss.header}>
                <Image
                    source={require('../assets/checkup_medical_app_logo.png')}
                    style={stylesssss.logo}
                />
            </View>
            <Animatable.View
                animation="fadeInUpBig"
                style={[stylesssss.footer, {
                }]}
            >
                <View style={stylesssss.action}>
                    <TextInput
                        placeholder="Email"
                        placeholderTextColor="#D3D3D3"
                        autoCapitalize='none'
                        style={[stylesssss.textInput, {
                        }]}
                        autoCapitalize="none"
                ...
                <TouchableOpacity style={stylesssss.signUpBtn}>
                    <Text style={stylesssss.signUpText}>Signup</Text>
                </TouchableOpacity>
            </Animatable.View>
        </View>
    );
